...
/**
 * The daily check-in: sleep, weight, pushups, water, supplements, the Daily
 * Dozen tally and the streak.
 *
 * This was the Home tab. David, 2026-07-25: Home only ever linked to Cook,
 * so the tab retired and its contents moved here, to the top of CARNET,
 * beside the scanners and the shared meals. Nothing about the check-in
 * itself changed.
 * @param {{
 ...
 * }} props
 */
export function CheckInView({ daily, targets, today, loading, onPatchDay, adherence }) {
  ...
  return html`
    ${
      ...
      // confirmations only, cooked meals and the receipt and the daily logs.
      ...
      html`<div class="tile">
        ...
        <div class="d num"><b>${adherence.score}</b> / 100</div>
      </div>`
    }
    ...
    ${
      ...
      html`<div class="tile">
        ...
        <p class="hint">
          weigh right after waking, after the bathroom, before eating or drinking, no clothes. same
          routine every time.
        </p>`
    }
    ${
